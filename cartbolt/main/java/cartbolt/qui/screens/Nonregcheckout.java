...
public class Nonregcheckout extends AppCompatActivity {

    private EditText ckname, ckemail ,ckphone, ckaread;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nonregcheckout);
        ...
        //Edit fields
        ckname = (EditText) findViewById(R.id.cknamefield);
        ckphone = (EditText) findViewById(R.id.ckphonefield);
        ckemail = (EditText) findViewById(R.id.ckemailfield);
        ckaread = (EditText) findViewById(R.id.ckareadfield);

        //Terms & Conditions
        checkterms = (CheckBox) findViewById(R.id.checktermsfield);
        checktermslink = (TextView) findViewById(R.id.checktermslinkfield);
        checktermslink.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                startActivity(new Intent(Nonregcheckout.this, Terms.class));
            }
        });

        //Spninners
        emode = (Spinner) findViewById(R.id.exitmoderfield);
        populateSpinner(emode);
        emode.setOnItemSelectedListener(new SpinnerSelect());

        checkloc = (Spinner) findViewById(R.id.checklocfield);
        populateLocationsSpinner(checkloc);
        checkloc.setOnItemSelectedListener(new LocationsSpinnerSelect());

        checkarea = (Spinner) findViewById(R.id.checkareafield);

        cancel = (Button) findViewById(R.id.btcfield);
        ...
        crt = (TextView) findViewById(R.id.delttlfield);
        del = (TextView) findViewById(R.id.delfeefield);
        grand = (TextView) findViewById(R.id.delgrandfield);
    ...
    private void populateSpinner(Spinner sp) {
        ...
        list.add("Withni Bugolobi   : 1hr - 3000");
    ...
    private class SpinnerSelect implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View v, int pos,
            ...
            theultimate = (Button) findViewById(R.id.theultimatefield);
            theultimate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (checkterms.isChecked()) {
                        ...
                        Toast.makeText(Nonregcheckout.this, "Please view and confirm with the terms and conditions",
    ...
    private void goGoGo() throws JSONException {
        ...
        userid = "1";
        username = ckname.getText().toString();
        userphone = ckphone.getText().toString();
        useremail = ckemail.getText().toString();
        if (username.isEmpty() || username.length() < 4) {
            Toast.makeText(Nonregcheckout.this, "Check your name", Toast.LENGTH_SHORT).show();
        } else if (userphone.isEmpty() || userphone.length() < 10) {
            Toast.makeText(Nonregcheckout.this, "Check your phone number", Toast.LENGTH_SHORT).show();
        } else if (useremail.isEmpty() || useremail.length() < 5 || (!useremail.contains("@"))) {
            Toast.makeText(Nonregcheckout.this, "Check your email", Toast.LENGTH_SHORT).show();
        } else {
            ...
            String url = /*Globals.server*/"http://www.cartbolt.ug/raw" + "/order.php?j=" + JSONer.buildJSONOrderArray(userid, username, userphone, useremail,
                    arealoctxt.replace(" ", "%20"), dectxt, typetxt, ttltxt, mkuptxt, deltxt, grandtxt).toString();
            System.out.println(url);

            final ProgressDialog pDialog = new ProgressDialog(Nonregcheckout.this);
            ...
            JsonArrayRequest req = new JsonArrayRequest(url,
                    new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            Toast.makeText(Nonregcheckout.this, "Received", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(Nonregcheckout.this, Homer.class));
                        }
